...
var sound_array: Array = [
	preload("res://Assets/VO/Wrong/DoesntLookRight.mp3"),
	preload("res://Assets/VO/Wrong/No.mp3"),
	preload("res://Assets/VO/Wrong/NotWhatImLookingFor.mp3"),
	preload("res://Assets/VO/Wrong/ThatLooksWeird.mp3"),
	preload("res://Assets/VO/Wrong/ThisIsntIt.mp3")
